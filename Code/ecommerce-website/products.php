...
<body>
<div class="anchor" id="test-main"></div>
<!--header -->
 <?php
...
<div class="container" style="margin-top:65px">
        <div class="anchor" id="test-jumb"></div>
    ...
    <div class="row text-center" id="watch">
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <div class="anchor" id="test-none1"></div>
                <img src="images/watch1.jpg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Guess 1875</h6>
                    <h6>Price :Rs 3000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><div style="position:relative"><a href="index.php#login" role="button" class="btn btn-warning  text-white "><div class="anchor cart"></div>Add To Cart</a></div></p>
                    <?php
                    } else {
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
            <div class="anchor" id="test-none2"></div>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <div class="anchor" id="test-none3"></div>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <div class="anchor" id="test-none4"></div>
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                <div class="anchor" id="test-none5"></div>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                <div class="anchor" id="test-none6"></div>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                <div class="anchor" id="test-none7"></div>
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                <div class="anchor" id="test-none8"></div>
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                <div class="anchor" id="test-none9"></div>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                <div class="anchor" id="test-none10"></div>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                <div class="anchor" id="test-none11"></div>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                <div class="anchor" id="test-none12"></div>
