...
include("TimedBar.php")

?>            
<!--Navigation bar start-->
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
